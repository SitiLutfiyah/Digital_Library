                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="return confirm('Apakah Anda yakin ingin menghapus data peminjaman ini?');" href="?page=peminjaman_hapus&&id=<?php echo $data['id_peminjaman']; ?>" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                        <?php
                        }
